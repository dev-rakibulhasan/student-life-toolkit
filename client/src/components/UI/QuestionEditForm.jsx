...
const QuestionEditForm = ({ questionId, onClose, onUpdate }) => {
  const { updateQuestion, getQuestion } = useQuestions();
  ...
  }, [questionId, getQuestion, onClose]);
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await updateQuestion(questionId, submissionData);
